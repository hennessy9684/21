...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-_-da@t=#+s$qyul)xwkx9yevq_32&x811+lh8l*1)zu8*bo^5c')
...
if os.environ.get('USE_MYSQL', 'False') == 'True':
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('MYSQL_DATABASE', 'day21'),
            'USER': os.environ.get('MYSQL_USER', 'day21_user'),
